...
raw = mne.io.read_raw_brainvision('/media/sf_E_DRIVE/badger_eeg/russell/retino_gamma_01.vhdr',montage=montage,eog=[31])
...
slice_epochs = remove_nongradient_epochs(slice_epochs)
